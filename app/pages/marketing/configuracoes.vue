<template>
  <div>
    ...
    <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
      ...
      <h3 class="text-lg font-bold text-gray-800 mb-2">Ajustes do Marketing</h3>
      <p class="text-gray-500 max-w-md">Opções e personalizações da área de marketing ficarão disponíveis aqui.</p>
    </div>
  </div>
</template>
