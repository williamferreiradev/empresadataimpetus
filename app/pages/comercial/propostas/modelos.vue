  ...
  <div class="flex flex-col h-full bg-gray-50">
    ...
    <div class="flex items-center justify-between mb-6 px-8 pt-8">
      <div class="flex items-center">
        <NuxtLink to="/comercial/propostas" class="mr-4 p-2.5 rounded-xl bg-white border border-gray-200 hover:bg-gray-50 text-gray-500 hover:text-gray-900 transition-all shadow-sm">
          <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
          </svg>
        </NuxtLink>
        <div>
          <h1 class="text-2xl font-black text-gray-900 tracking-tight">Modelos de Site</h1>
    ...
    <div class="flex gap-8 flex-1 min-h-0 px-8 pb-8">
      ...
      <div class="w-[340px] shrink-0 flex flex-col gap-3 overflow-y-auto pr-2 custom-scrollbar">
        ...
        >
          ...
          <div class="flex-1 min-w-0 pt-1">
            <h3 class="font-bold text-gray-900 text-base mb-1">{{ modelo.nome }}</h3>
            <p class="text-sm text-gray-500 leading-relaxed line-clamp-2">{{ modelo.descricao }}</p>
      ...
      <!-- Preview Area -->
      <div class="flex-1 bg-white rounded-3xl border border-gray-200 shadow-xl overflow-hidden flex flex-col relative">

        <!-- Sem seleção -->
        <div v-if="!modeloSelecionado" class="h-full flex flex-col items-center justify-center text-center p-12 bg-gray-50/50">
          <div class="w-24 h-24 bg-white shadow-sm border border-gray-100 rounded-3xl flex items-center justify-center mx-auto mb-6">
            <svg class="w-10 h-10 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </div>
          <h3 class="text-xl font-bold text-gray-900 mb-2">Selecione um modelo</h3>
          <p class="text-gray-500 max-w-md">O preview do site aparecerá aqui. Você pode usar a imagem do template real que o cliente vai receber.</p>
        </div>

        <!-- Preview do modelo -->
        <div v-else class="h-full flex flex-col bg-gray-100">
          <!-- Browser Bar -->
          <div class="flex items-center gap-3 px-5 py-3 bg-white border-b border-gray-200 shrink-0 z-10">
            ...
            <div class="flex-1 flex justify-center">
              <div class="bg-gray-100/80 rounded-lg px-4 py-1.5 text-xs text-gray-500 font-medium font-mono w-full max-w-md text-center border border-gray-200/50 shadow-inner">
                <span class="text-gray-400">https://</span>proposta.dataimpetus.com/{{ modeloSelecionado.id }}
              </div>
            </div>
          ...
          <div class="flex-1 overflow-y-auto relative w-full h-full custom-scrollbar bg-gray-50">
              ...
              <header class="flex justify-between items-center px-12 py-6 border-b border-white/5">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-[10px] tracking-widest text-gray-400 uppercase">Barbearia Premium</p>
                  </div>
                </div>
                ...
                <div class="flex-1">
                  ...
                  <div class="grid grid-cols-3 gap-8 mt-20 pt-10 border-t border-white/10 max-w-lg">
                    <div>
                      ...
                      <p class="text-[10px] uppercase tracking-widest text-gray-500">Clientes</p>
                    </div>
                    <div>
                      <p class="text-3xl font-bold text-[#eab308] mb-1">15</p>
                      <p class="text-[10px] uppercase tracking-widest text-gray-500">Barbeiros</p>
                    </div>
                    <div>
                      <p class="text-3xl font-bold text-[#eab308] mb-1">100%</p>
                      <p class="text-[10px] uppercase tracking-widest text-gray-500">Satisfação</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="flex-1 relative">
                  ...
                  <div class="bg-gray-900 h-[600px] w-full relative z-10 overflow-hidden group">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                      <svg class="w-24 h-24 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div v-else-if="modeloSelecionado.id === 'despachante' || modeloSelecionado.id === 'autocenter'" class="w-full bg-white min-h-full font-sans">
              <!-- Header Despachante -->
              <header class="flex justify-between items-center px-12 py-4 border-b border-gray-100">
                <div class="flex items-center gap-2">
                  <div class="w-8 h-8 rounded-full bg-red-600 text-white font-black flex items-center justify-center text-sm">DC</div>
                  <h2 class="font-black text-xl italic tracking-tighter text-gray-900">Despachante<br><span class="text-red-600 text-lg leading-none block -mt-1">Conexão</span></h2>
                </div>
                <nav class="hidden md:flex gap-8 text-sm font-semibold text-gray-500">
                  ...
                  <a href="#" class="hover:text-gray-900">Parceiros</a>
              ...
              <!-- Hero Despachante -->
              <div class="flex items-center px-12 py-20 gap-12 bg-gray-50/50">
                <div class="flex-1">
                  <p class="text-gray-400 text-xs font-bold tracking-widest uppercase mb-4 flex items-center gap-2">
                    <span class="w-2 h-2 bg-red-600 rounded-full"></span>
                    Despachante número 1 do Tocantins
                  </p>
                  <h1 class="text-5xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight">
                  ...
                  <div class="flex gap-4 items-center">
                    ...
                    <button class="bg-white border border-gray-200 text-gray-700 font-bold px-8 py-3.5 rounded-full hover:bg-gray-50 transition-colors">
                      Ver Serviços
                    </button>
                  </div>
                  <p class="text-xs text-gray-400 mt-6 font-medium flex items-center gap-1">
                ...
                <div class="flex-1 relative flex justify-center">
                  <div class="w-[450px] h-[450px] rounded-full border border-gray-200 relative flex items-center justify-center bg-white shadow-xl shadow-gray-200/50">
                    <div class="absolute -top-4 right-10 w-3 h-3 bg-red-600 rounded-full"></div>
                    <!-- Logo / Graphic placeholder -->
                    <h2 class="font-black text-5xl italic tracking-tighter text-gray-900 text-center">
                      <span class="text-gray-300">DESPACHANTE</span><br>
                      <span class="text-red-600 text-6xl leading-none">Conexão</span>
                    </h2>
                    
                    <!-- Floating badge -->
                    <div class="absolute -bottom-6 right-10 bg-white rounded-xl shadow-xl border border-gray-100 p-4 flex items-center gap-3">
                      ...
                      <div>
                        <p class="font-black text-gray-900 text-lg leading-none">100%</p>
                        <p class="text-[9px] uppercase tracking-wider text-gray-500 font-bold mt-0.5">Veículos Regularizados</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div v-else class="w-full bg-white min-h-full">
              <!-- Header -->
              <header class="flex justify-between items-center px-10 py-5 border-b border-gray-100">
                ...
                <nav class="hidden md:flex gap-8 text-sm font-bold text-gray-500">
              ...
              <div class="px-10 py-20 flex flex-col items-center text-center max-w-4xl mx-auto">
                ...
                <h1 class="text-5xl font-black text-gray-900 leading-tight mb-6 tracking-tight">
                  {{ modeloSelecionado.hero.headline }}
                </h1>
                <p class="text-xl text-gray-500 mb-10 max-w-2xl leading-relaxed">
                  {{ modeloSelecionado.hero.subheadline }}
                </p>
                <div class="w-full aspect-video rounded-3xl bg-gray-100 border border-gray-200 flex items-center justify-center shadow-inner overflow-hidden relative">
                   ...
                   <div class="w-20 h-20 rounded-full bg-white shadow-xl flex items-center justify-center relative z-10 text-4xl">
