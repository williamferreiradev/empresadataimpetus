...
watch(
  () => [props.data.shape, props.data.category, props.data.width, props.data.height],
  () => {
    drawRoughNode()
  },
  { deep: true }
...
<template>
  ...
  >
    ...
    <Handle id="left-t" type="target" :position="Position.Left" class="node-handle handle-left" />
    <Handle id="left-s" type="source" :position="Position.Left" class="node-handle handle-left" />
    ...
    <Handle id="right-t" type="target" :position="Position.Right" class="node-handle handle-right" />
    <Handle id="right-s" type="source" :position="Position.Right" class="node-handle handle-right" />
